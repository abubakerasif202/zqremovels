...
FAQ_DATA = {
    'index.html': [
        ("How much do removalists cost in Adelaide?",
         "Adelaide house move cost depends on home size, access, distance, inventory, timing, and whether packing support is needed. Request a fixed-price quote for your specific job."),
    ...
    'removalists-adelaide/index.html': [
        ("How much do Adelaide removalists charge?",
         "Adelaide removalist cost depends on inventory, access, stairs or lifts, distance, packing requirements, timing, and crew needs. We provide a fixed-price quote after reviewing the brief."),
        ("How long does a typical Adelaide house move take?",
         "Move duration depends on inventory, access, packing status, parking, stairs or lifts, and travel distance. We will give you an estimated timeframe when you request your quote."),
    ...
    'removalists-glenelg/index.html': [
        ...
        ("How much does a removal in Glenelg cost?",
         "Glenelg removal cost depends on home size, coastal access, stairs or lifts, parking, inventory, timing, and distance. Request a fixed-price quote for your specific job."),
    ...
    'removalists-marion/index.html': [
        ...
        ("How much does a removal in Marion cost?",
         "Marion removal cost depends on home size, access, inventory, stairs or lifts, parking, timing, and distance. Request a fixed-price quote for an accurate price."),
    ...
    'furniture-removalists-adelaide/index.html': [
        ...
        ("How much does furniture removal cost in Adelaide?",
         "Furniture removal cost depends on item size, volume, access, stairs or lifts, distance, wrapping needs, and timing. Request a fixed-price quote for your specific job."),
    ...
    'removalists-salisbury/index.html': [
        ...
        ("How much does a removal in Salisbury cost?",
         "Salisbury removal cost depends on home size, access, inventory, storage stops, parking, timing, and distance. Request a fixed-price quote for your specific job."),
    ...
    'adelaide-moving-guides/removalists-cost-adelaide/index.html': [
        ("What affects removalist rates in Adelaide?",
         "Adelaide removalist rates vary by crew size, truck size, access, inventory, timing, and inclusions. A very low headline rate can be risky if travel time, insurance, stairs, or heavy items are not explained clearly."),
        ("Is there a minimum charge for removalists in Adelaide?",
         "Minimum booking rules and travel charges vary by provider. Confirm callout fees, travel time, inclusions, access charges, and fixed-price options before booking."),
